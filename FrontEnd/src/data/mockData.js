...
//   {
//     id: "WD-1001", // ID dạng chuỗi nhìn chuyên nghiệp hơn
//     storeId: "RES-01",
//     storeName: "KHK Food Quận 1",
//     amount: 5000000,
//     status: "pending", // SỬA: Viết thường để khớp với code Frontend
...
//     amount: 2500000,
//     status: "approved", // SỬA: Viết thường
...
//     storeName: "KHK Food Quận 1",
//     amount: 1500000,
//     status: "rejected", // SỬA: Viết thường
...
//   // 6. WITHDRAWS (ĐÃ SỬA: THÊM HÀM CREATE)
//   withdraws: {
//     getAll: () => getFromLS(DB_KEYS.WITHDRAWS, SEED_WITHDRAW_REQUESTS),

//     // [BỔ SUNG QUAN TRỌNG] Hàm tạo yêu cầu rút tiền
//     create: (requestData) => {
...
//         id: newId,
//         status: "pending",
//         requestDate: new Date().toLocaleString("vi-VN"), // Format ngày giờ
//         ...requestData, // bao gồm: storeId, storeName, amount, bankInfo
//       };

//       list.unshift(newRequest); // Thêm vào đầu danh sách
...
//   // 7. [BỔ SUNG QUAN TRỌNG] WALLET - TÍNH TOÁN VÍ TIỀN
//   wallet: {
//     getStats: (storeId) => {
//       // 1. Tổng doanh thu (Từ đơn hàng COMPLETED)
...
//       // 2. Tổng tiền đã rút (APPROVED) & Đang chờ (PENDING)
...
//         totalPending,
//         availableBalance,
//         history: storeWithdraws, // Lịch sử rút tiền
//       };
//     },
//   },
// };
