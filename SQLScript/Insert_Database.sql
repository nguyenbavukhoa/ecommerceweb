...
-- ===============================================
-- 5. PRODUCTS (Sản phẩm cụ thể)
-- ===============================================

-- Phở (product_categories_id: 1)
INSERT INTO product (id, name, description, img_main, is_active, price_base, product_categories_id, created_at, updated_at) VALUES
(1, 'Phở Bò Hà Nội', 'Phở bò truyền thống với nước dùng được ninh từ xương bò suốt 12 tiếng, thịt bò tươi ngon và bánh phở dai mềm', '/images/pho-bo-hanoi.jpg', 1, 45000, 1, NOW(), NOW()),
(2, 'Phở Gà Thơm Ngon', 'Phở gà với nước dùng trong vắt, thịt gà thả vườn tươi ngon, rau thơm đầy đủ', '/images/pho-ga.jpg', 1, 40000, 1, NOW(), NOW()),
(3, 'Phở Đặc Biệt Sài Gòn', 'Phở đặc biệt với đầy đủ loại thịt bò: tái, chín, gầu, gân, sách. Phù hợp cho những ai muốn thưởng thức trọn vẹn hương vị phở', '/images/pho-dac-biet.jpg', 1, 55000, 1, NOW(), NOW()),

-- Bún bò Huế (product_categories_id: 2)
(4, 'Bún Bò Huế Chính Gốc', 'Bún bò Huế với nước dùng cay nồng, chả cua, giò heo, bún tươi và rau sống đặc trưng xứ Huế', '/images/bun-bo-hue.jpg', 1, 48000, 2, NOW(), NOW()),
(5, 'Bún Bò Huế Chay', 'Phiên bản chay của bún bò Huế với nước dùng từ nấm và rau củ, đậu hũ chiên và rau sống', '/images/bun-bo-hue-chay.jpg', 1, 42000, 2, NOW(), NOW()),

-- Bánh mì (product_categories_id: 3)
(6, 'Bánh Mì Thịt Nướng', 'Bánh mì giòn rụm với thịt nướng thơm lừng, pate, rau sống và gia vị đặc biệt', '/images/banh-mi-thit-nuong.jpg', 1, 25000, 3, NOW(), NOW()),
(7, 'Bánh Mì Pate', 'Bánh mì truyền thống với pate gan heo, chả lụa, dưa leo và rau thơm', '/images/banh-mi-pate.jpg', 1, 20000, 3, NOW(), NOW()),
(8, 'Bánh Mì Đặc Biệt', 'Bánh mì với đầy đủ loại nhân: thịt nướng, pate, chả cua, trứng và rau sống', '/images/banh-mi-dac-biet.jpg', 1, 35000, 3, NOW(), NOW()),

-- Cơm tấm (product_categories_id: 4)
(9, 'Cơm Tấm Sườn Nướng', 'Cơm tấm với sườn nướng thơm phức, chả trứng, bì và nước mắm pha chua ngọt', '/images/com-tam-suon-nuong.jpg', 1, 35000, 4, NOW(), NOW()),
(10, 'Cơm Tấm Đặc Biệt', 'Cơm tấm đầy đủ với sườn nướng, bì, chả, trứng và tôm khô rang', '/images/com-tam-dac-biet.jpg', 1, 45000, 4, NOW(), NOW()),

-- Pizza Italy (product_categories_id: 36)
(11, 'Pizza Margherita Classic', 'Pizza truyền thống Italy với sốt cà chua tươi, phô mai Mozzarella và lá húng quế tươi', '/images/pizza-margherita.jpg', 1, 150000, 36, NOW(), NOW()),
(12, 'Pizza Quattro Stagioni', 'Pizza 4 mùa với nấm, ham, artichoke và olives trên nền sốt cà chua thơm ngon', '/images/pizza-quattro-stagioni.jpg', 1, 180000, 36, NOW(), NOW()),
(13, 'Pizza Diavola', 'Pizza cay với pepperoni cay, phô mai Mozzarella và ớt đỏ tươi', '/images/pizza-diavola.jpg', 1, 170000, 36, NOW(), NOW()),

-- Pizza Mỹ (product_categories_id: 37)
(14, 'Pizza Supreme', 'Pizza kiểu Mỹ với pepperoni, xúc xích, ớt chuông, nấm và hành tây', '/images/pizza-supreme.jpg', 1, 200000, 37, NOW(), NOW()),
(15, 'Pizza Meat Lovers', 'Pizza dành cho người yêu thịt với pepperoni, xúc xích, thịt xông khói và ham', '/images/pizza-meat-lovers.jpg', 1, 220000, 37, NOW(), NOW()),

-- Burger bò (product_categories_id: 38)
(16, 'Classic Beef Burger', 'Burger bò classic với thịt bò Angus 100%, rau xanh, cà chua và sốt đặc biệt', '/images/classic-beef-burger.jpg', 1, 65000, 38, NOW(), NOW()),
(17, 'BBQ Bacon Burger', 'Burger bò với thịt xông khói giòn, sốt BBQ và hành tây chiên', '/images/bbq-bacon-burger.jpg', 1, 75000, 38, NOW(), NOW()),
(18, 'Double Cheeseburger', 'Burger 2 lớp thịt bò với phô mai cheddar tan chảy', '/images/double-cheeseburger.jpg', 1, 95000, 38, NOW(), NOW()),

-- Burger gà (product_categories_id: 39)
(19, 'Crispy Chicken Burger', 'Burger gà giòn rụm với sốt mayonnaise và rau xanh tươi', '/images/crispy-chicken-burger.jpg', 1, 58000, 39, NOW(), NOW()),
(20, 'Spicy Chicken Burger', 'Burger gà cay với sốt buffalo và dưa chuột muối', '/images/spicy-chicken-burger.jpg', 1, 62000, 39, NOW(), NOW()),

-- Trà sữa trân châu (product_categories_id: 41)
(21, 'Trà Sữa Trân Châu Đường Đen', 'Trà sữa đậm đà với trân châu đường đen dai mềm và cream cheese béo ngậy', '/images/tra-sua-tran-chau-duong-den.jpg', 1, 35000, 41, NOW(), NOW()),
(22, 'Trà Sữa Oolong Truyền Thống', 'Trà sữa pha từ trà oolong cao cấp với trân châu trắng và đường phên', '/images/tra-sua-oolong.jpg', 1, 32000, 41, NOW(), NOW()),
(23, 'Trà Sữa Matcha', 'Trà sữa vị matcha Nhật Bản thơm ngon với topping trân châu và thạch dừa', '/images/tra-sua-matcha.jpg', 1, 38000, 41, NOW(), NOW()),

-- Trà sữa kem cheese (product_categories_id: 42)
(24, 'Brown Sugar Milk Tea', 'Trà sữa đường nâu với lớp kem cheese mặn ngọt hài hòa', '/images/brown-sugar-milk-tea.jpg', 1, 42000, 42, NOW(), NOW()),
(25, 'Taro Milk Tea Cheese', 'Trà sữa khoai môn với kem cheese thơm béo', '/images/taro-cheese-milk-tea.jpg', 1, 40000, 42, NOW(), NOW()),

-- Cà phê đen (product_categories_id: 43)
(26, 'Cà Phê Đen Đá', 'Cà phê đen truyền thống pha phin với hạt cà phê Robusta đậm đà', '/images/ca-phe-den-da.jpg', 1, 18000, 43, NOW(), NOW()),
(27, 'Cà Phê Đen Nóng', 'Cà phê đen nóng thơm lừng, phù hợp cho buổi sáng', '/images/ca-phe-den-nong.jpg', 1, 15000, 43, NOW(), NOW()),

-- Cà phê sữa (product_categories_id: 44)
(28, 'Cà Phê Sữa Đá', 'Cà phê sữa đá truyền thống Việt Nam với sữa đặc ngọt ngào', '/images/ca-phe-sua-da.jpg', 1, 22000, 44, NOW(), NOW()),
(29, 'Bạc Xỉu Đá', 'Bạc xỉu với tỷ lệ sữa nhiều hơn, vị ngọt nhẹ nhàng', '/images/bac-xiu-da.jpg', 1, 25000, 44, NOW(), NOW()),

-- Gà rán (product_categories_id: 75)
(30, 'Gà Rán Giòn Truyền Thống', 'Gà rán với lớp vỏ giòn rụm, thịt gà mềm ngọt bên trong, tẩm ướp gia vị đặc biệt', '/images/ga-ran-gion-truyen-thong.jpg', 1, 45000, 75, NOW(), NOW()),
(31, 'Gà Rán Cay Hàn Quốc', 'Gà rán kiểu Hàn Quốc với sốt gochujang cay nồng và mè rang', '/images/ga-ran-cay-han-quoc.jpg', 1, 50000, 75, NOW(), NOW()),
(32, 'Gà Rán Mật Ong', 'Gà rán tẩm sốt mật ong ngọt ngào, thơm phức', '/images/ga-ran-mat-ong.jpg', 1, 53000, 75, NOW(), NOW()),

-- Lẩu Thái (product_categories_id: 15)
(33, 'Lẩu Tom Yum Hải Sản', 'Lẩu Tom Yum chua cay với tôm, mực, cua và nấm các loại', '/images/lau-tom-yum-hai-san.jpg', 1, 180000, 15, NOW(), NOW()),
(34, 'Lẩu Thái Chay', 'Lẩu Thái chay với nước dùng từ rau củ và nấm, đậu phụ và rau xanh', '/images/lau-thai-chay.jpg', 1, 150000, 15, NOW(), NOW()),

-- Sushi (product_categories_id: 25)
(35, 'Sashimi Mix Set', 'Set sashimi gồm cá hồi, cá ngừ và cá trắng tươi ngon', '/images/sashimi-mix-set.jpg', 1, 120000, 25, NOW(), NOW()),
(36, 'California Roll', 'Sushi cuộn California với cua, bơ và dưa chuột', '/images/california-roll.jpg', 1, 85000, 25, NOW(), NOW()),
(37, 'Salmon Teriyaki Roll', 'Sushi cuốn cá hồi nướng teriyaki với rong biển và cơm', '/images/salmon-teriyaki-roll.jpg', 1, 95000, 25, NOW(), NOW()),

-- Ramen (product_categories_id: 27)
(38, 'Shoyu Ramen', 'Ramen nước dùng shoyu (nước tương) với thịt xá xíu, trứng lòng đào và rau xanh', '/images/shoyu-ramen.jpg', 1, 55000, 27, NOW(), NOW()),
(39, 'Tonkotsu Ramen', 'Ramen nước dùng xương heo đậm đà với thịt xá xíu và trứng lòng đào', '/images/tonkotsu-ramen.jpg', 1, 65000, 27, NOW(), NOW()),
(40, 'Miso Ramen', 'Ramen nước dùng miso với rau củ và thịt heo', '/images/miso-ramen.jpg', 1, 60000, 27, NOW(), NOW()),

-- Thêm một số sản phẩm khác
-- Xôi (product_categories_id: 70)
(41, 'Xôi Gà', 'Xôi nếp thơm với thịt gà luộc, hành phi và nước mắm', '/images/xoi-ga.jpg', 1, 25000, 70, NOW(), NOW()),
(42, 'Xôi Xíu Mại', 'Xôi nếp với xíu mại hấp và tương ớt', '/images/xoi-xiu-mai.jpg', 1, 22000, 70, NOW(), NOW()),

-- Cháo (product_categories_id: 72)
(43, 'Cháo Gà Tần', 'Cháo gà ninh nhừ với thịt gà băm và rau thơm', '/images/chao-ga-tan.jpg', 1, 28000, 72, NOW(), NOW()),
(44, 'Cháo Hến', 'Cháo hến đặc sản với hến xào và rau thơm', '/images/chao-hen.jpg', 1, 30000, 72, NOW(), NOW()),

-- Sinh tố (product_categories_id: 63)
(45, 'Sinh Tố Bơ', 'Sinh tố bơ béo ngậy với sữa tươi và đá bào', '/images/sinh-to-bo.jpg', 1, 28000, 63, NOW(), NOW()),
(46, 'Sinh Tố Dâu', 'Sinh tố dâu tây tươi mát với sữa chua', '/images/sinh-to-dau.jpg', 1, 32000, 63, NOW(), NOW()),

-- Bánh ngọt (product_categories_id: 47)
(47, 'Tiramisu', 'Bánh Tiramisu Italy với lớp kem mascarpone và cà phê đắng', '/images/tiramisu.jpg', 1, 45000, 47, NOW(), NOW()),
(48, 'Cheesecake Blueberry', 'Bánh phô mai với topping blueberry tươi', '/images/cheesecake-blueberry.jpg', 1, 50000, 47, NOW(), NOW()),

-- Salad (product_categories_id: 56)
(49, 'Salad Caesar', 'Salad Caesar với rau xà lách, phô mai parmesan và sốt Caesar', '/images/salad-caesar.jpg', 1, 65000, 56, NOW(), NOW()),
(50, 'Salad Cobb', 'Salad Cobb với gà nướng, thịt xông khói, trứng và bơ', '/images/salad-cobb.jpg', 1, 75000, 56, NOW(), NOW());

-- ===============================================
-- PRODUCT VARIANTS (Biến thể sản phẩm cụ thể)
-- ===============================================

-- Phở Bò Hà Nội (product_id: 1) với các variant options
INSERT INTO product_variant (id, created_at, updated_at, imgurl, price, status, sku, stock_quantity, product_id, variant_option_id) VALUES
-- Loại phở (variant_option_id: 1)
(1, NOW(), NOW(), '/images/pho-bo-tai.jpg', 45000, 1, 'PHO-BO-TAI-001', 50, 1, 1),
(2, NOW(), NOW(), '/images/pho-bo-chin.jpg', 45000, 1, 'PHO-BO-CHIN-001', 50, 1, 1),
(3, NOW(), NOW(), '/images/pho-dac-biet-hanoi.jpg', 55000, 1, 'PHO-DAC-BIET-001', 25, 1, 1),
-- Size (variant_option_id: 2)
(4, NOW(), NOW(), '/images/pho-size-nho.jpg', 0, 1, 'PHO-SIZE-S-001', 100, 1, 2),
(5, NOW(), NOW(), '/images/pho-size-vua.jpg', 5000, 1, 'PHO-SIZE-M-001', 100, 1, 2),
(6, NOW(), NOW(), '/images/pho-size-lon.jpg', 10000, 1, 'PHO-SIZE-L-001', 100, 1, 2),
-- Topping (variant_option_id: 3)
(7, NOW(), NOW(), '/images/pho-them-thit.jpg', 15000, 1, 'PHO-THEM-THIT-001', 50, 1, 3),
(8, NOW(), NOW(), '/images/pho-them-trung.jpg', 8000, 1, 'PHO-THEM-TRUNG-001', 50, 1, 3),

-- Phở Gà (product_id: 2)
(9, NOW(), NOW(), '/images/pho-ga-standard.jpg', 40000, 1, 'PHO-GA-STD-002', 30, 2, 1),
(10, NOW(), NOW(), '/images/pho-ga-size-s.jpg', 0, 1, 'PHO-GA-SIZE-S-002', 100, 2, 2),
(11, NOW(), NOW(), '/images/pho-ga-size-l.jpg', 10000, 1, 'PHO-GA-SIZE-L-002', 100, 2, 2),

-- Bánh Mì Thịt Nướng (product_id: 6)
(12, NOW(), NOW(), '/images/banh-mi-thit-nuong-std.jpg', 25000, 1, 'BANH-MI-TN-006', 40, 6, 4),
(13, NOW(), NOW(), '/images/banh-mi-combo-nuoc-ngot.jpg', 10000, 1, 'BANH-MI-COMBO-NS-006', 50, 6, 5),
(14, NOW(), NOW(), '/images/banh-mi-combo-ca-phe.jpg', 15000, 1, 'BANH-MI-COMBO-CF-006', 30, 6, 5),

-- Bánh Mì Pate (product_id: 7)
(15, NOW(), NOW(), '/images/banh-mi-pate-std.jpg', 20000, 1, 'BANH-MI-PATE-007', 40, 7, 4),
(16, NOW(), NOW(), '/images/banh-mi-pate-combo.jpg', 10000, 1, 'BANH-MI-PATE-COMBO-007', 50, 7, 5),

-- Cơm Tấm Sườn Nướng (product_id: 9)
(17, NOW(), NOW(), '/images/com-tam-suon-std.jpg', 35000, 1, 'COM-TAM-SUON-009', 30, 9, 6),
(18, NOW(), NOW(), '/images/com-tam-combo-nuoc.jpg', 15000, 1, 'COM-TAM-COMBO-009', 25, 9, 7),

-- Pizza Margherita (product_id: 11)
(19, NOW(), NOW(), '/images/pizza-margherita-s.jpg', 150000, 1, 'PIZZA-MAR-S-011', 20, 11, 8),
(20, NOW(), NOW(), '/images/pizza-margherita-m.jpg', 220000, 1, 'PIZZA-MAR-M-011', 15, 11, 8),
(21, NOW(), NOW(), '/images/pizza-margherita-l.jpg', 320000, 1, 'PIZZA-MAR-L-011', 10, 11, 8),
-- Đế pizza (variant_option_id: 9)
(22, NOW(), NOW(), '/images/pizza-de-mong.jpg', 0, 1, 'PIZZA-DE-MONG-011', 50, 11, 9),
(23, NOW(), NOW(), '/images/pizza-de-day.jpg', 15000, 1, 'PIZZA-DE-DAY-011', 50, 11, 9),
(24, NOW(), NOW(), '/images/pizza-de-pho-mai.jpg', 25000, 1, 'PIZZA-DE-CHEESE-011', 30, 11, 9),

-- Pizza Supreme (product_id: 14)
(25, NOW(), NOW(), '/images/pizza-supreme-s.jpg', 180000, 1, 'PIZZA-SUP-S-014', 20, 14, 11),
(26, NOW(), NOW(), '/images/pizza-supreme-m.jpg', 250000, 1, 'PIZZA-SUP-M-014', 15, 14, 11),
(27, NOW(), NOW(), '/images/pizza-supreme-l.jpg', 350000, 1, 'PIZZA-SUP-L-014', 10, 14, 11),

-- Classic Beef Burger (product_id: 16)
(28, NOW(), NOW(), '/images/burger-bo-classic.jpg', 65000, 1, 'BURGER-BO-CLA-016', 25, 16, 13),
(29, NOW(), NOW(), '/images/burger-combo-khoai.jpg', 25000, 1, 'BURGER-COMBO-K-016', 50, 16, 14),
(30, NOW(), NOW(), '/images/burger-combo-full.jpg', 35000, 1, 'BURGER-COMBO-F-016', 30, 16, 14),

-- BBQ Bacon Burger (product_id: 17)
(31, NOW(), NOW(), '/images/burger-bbq-bacon.jpg', 75000, 1, 'BURGER-BBQ-017', 20, 17, 13),
(32, NOW(), NOW(), '/images/burger-bbq-combo.jpg', 25000, 1, 'BURGER-BBQ-COMBO-017', 50, 17, 14),

-- Crispy Chicken Burger (product_id: 19)
(33, NOW(), NOW(), '/images/burger-ga-gion.jpg', 58000, 1, 'BURGER-GA-GION-019', 25, 19, 15),
(34, NOW(), NOW(), '/images/burger-ga-combo.jpg', 25000, 1, 'BURGER-GA-COMBO-019', 50, 19, 16),

-- Trà Sữa Trân Châu Đường Đen (product_id: 21)
(35, NOW(), NOW(), '/images/tra-sua-tc-dd-m.jpg', 35000, 1, 'TS-TC-DD-M-021', 100, 21, 17),
(36, NOW(), NOW(), '/images/tra-sua-tc-dd-l.jpg', 43000, 1, 'TS-TC-DD-L-021', 100, 21, 17),
(37, NOW(), NOW(), '/images/tra-sua-tc-dd-xl.jpg', 50000, 1, 'TS-TC-DD-XL-021', 50, 21, 17),
-- Độ ngọt (variant_option_id: 18)
(38, NOW(), NOW(), '/images/tra-sua-0-duong.jpg', 0, 1, 'TS-0DUONG-021', 100, 21, 18),
(39, NOW(), NOW(), '/images/tra-sua-50-duong.jpg', 0, 1, 'TS-50DUONG-021', 100, 21, 18),
(40, NOW(), NOW(), '/images/tra-sua-100-duong.jpg', 0, 1, 'TS-100DUONG-021', 100, 21, 18),
-- Topping (variant_option_id: 19)
(41, NOW(), NOW(), '/images/tra-sua-tran-chau-den.jpg', 5000, 1, 'TS-TRAN-CHAU-DEN-021', 100, 21, 19),
(42, NOW(), NOW(), '/images/tra-sua-tran-chau-trang.jpg', 5000, 1, 'TS-TRAN-CHAU-TRANG-021', 100, 21, 19),
(43, NOW(), NOW(), '/images/tra-sua-thach-dua.jpg', 8000, 1, 'TS-THACH-DUA-021', 50, 21, 19),

-- Trà Sữa Oolong (product_id: 22)
(44, NOW(), NOW(), '/images/tra-sua-oolong-m.jpg', 32000, 1, 'TS-OOLONG-M-022', 100, 22, 17),
(45, NOW(), NOW(), '/images/tra-sua-oolong-l.jpg', 40000, 1, 'TS-OOLONG-L-022', 100, 22, 17),

-- Brown Sugar Milk Tea (product_id: 24)
(46, NOW(), NOW(), '/images/brown-sugar-m.jpg', 42000, 1, 'BROWN-SUGAR-M-024', 100, 24, 20),
(47, NOW(), NOW(), '/images/brown-sugar-l.jpg', 52000, 1, 'BROWN-SUGAR-L-024', 100, 24, 20),
-- Độ ngọt (variant_option_id: 21)
(48, NOW(), NOW(), '/images/brown-sugar-0.jpg', 0, 1, 'BROWN-SUGAR-0-024', 100, 24, 21),
(49, NOW(), NOW(), '/images/brown-sugar-70.jpg', 0, 1, 'BROWN-SUGAR-70-024', 100, 24, 21),

-- Cà Phê Đen Đá (product_id: 26)
(50, NOW(), NOW(), '/images/ca-phe-den-nho.jpg', 18000, 1, 'CF-DEN-S-026', 100, 26, 22),
(51, NOW(), NOW(), '/images/ca-phe-den-lon.jpg', 26000, 1, 'CF-DEN-L-026', 100, 26, 22),

-- Cà Phê Sữa Đá (product_id: 28)
(52, NOW(), NOW(), '/images/ca-phe-sua-nho.jpg', 22000, 1, 'CF-SUA-S-028', 100, 28, 24),
(53, NOW(), NOW(), '/images/ca-phe-sua-lon.jpg', 32000, 1, 'CF-SUA-L-028', 100, 28, 24),

-- Gà Rán Giòn Truyền Thống (product_id: 30)
(54, NOW(), NOW(), '/images/ga-ran-2-mieng.jpg', 45000, 1, 'GA-RAN-2M-030', 30, 30, 26),
(55, NOW(), NOW(), '/images/ga-ran-4-mieng.jpg', 85000, 1, 'GA-RAN-4M-030', 25, 30, 26),
(56, NOW(), NOW(), '/images/ga-ran-6-mieng.jpg', 120000, 1, 'GA-RAN-6M-030', 20, 30, 26),
(57, NOW(), NOW(), '/images/ga-ran-9-mieng.jpg', 170000, 1, 'GA-RAN-9M-030', 15, 30, 26),
-- Vị (variant_option_id: 27)
(58, NOW(), NOW(), '/images/ga-ran-truyen-thong.jpg', 0, 1, 'GA-RAN-TT-030', 100, 30, 27),
(59, NOW(), NOW(), '/images/ga-ran-cay-han.jpg', 5000, 1, 'GA-RAN-CAY-030', 50, 30, 27),
(60, NOW(), NOW(), '/images/ga-ran-mat-ong.jpg', 8000, 1, 'GA-RAN-HONEY-030', 30, 30, 27),

-- Gà Rán Cay Hàn Quốc (product_id: 31)
(61, NOW(), NOW(), '/images/ga-ran-han-2m.jpg', 50000, 1, 'GA-HAN-2M-031', 30, 31, 26),
(62, NOW(), NOW(), '/images/ga-ran-han-4m.jpg', 90000, 1, 'GA-HAN-4M-031', 25, 31, 26),

-- Lẩu Tom Yum Hải Sản (product_id: 33)
(63, NOW(), NOW(), '/images/lau-tomyum-2-3ng.jpg', 180000, 1, 'LAU-TY-2-3-033', 15, 33, 29),
(64, NOW(), NOW(), '/images/lau-tomyum-4-5ng.jpg', 280000, 1, 'LAU-TY-4-5-033', 10, 33, 29),
(65, NOW(), NOW(), '/images/lau-tomyum-6-8ng.jpg', 380000, 1, 'LAU-TY-6-8-033', 8, 33, 29),

-- Sashimi Mix Set (product_id: 35)
(66, NOW(), NOW(), '/images/sashimi-8-mieng.jpg', 120000, 1, 'SASHIMI-8M-035', 20, 35, 33),
(67, NOW(), NOW(), '/images/sashimi-12-mieng.jpg', 180000, 1, 'SASHIMI-12M-035', 15, 35, 33),
(68, NOW(), NOW(), '/images/sashimi-16-mieng.jpg', 240000, 1, 'SASHIMI-16M-035', 10, 35, 33),

-- Shoyu Ramen (product_id: 38)
(69, NOW(), NOW(), '/images/shoyu-ramen-std.jpg', 55000, 1, 'SHOYU-RAMEN-038', 25, 38, 35),
-- Độ cay (variant_option_id: 37)
(70, NOW(), NOW(), '/images/ramen-khong-cay.jpg', 0, 1, 'RAMEN-0CAY-038', 50, 38, 37),
(71, NOW(), NOW(), '/images/ramen-cay-vua.jpg', 0, 1, 'RAMEN-CAY-VUA-038', 50, 38, 37),
(72, NOW(), NOW(), '/images/ramen-cay-nhieu.jpg', 0, 1, 'RAMEN-CAY-NHIEU-038', 30, 38, 37),

-- Tonkotsu Ramen (product_id: 39)
(73, NOW(), NOW(), '/images/tonkotsu-ramen-std.jpg', 65000, 1, 'TONKOTSU-RAMEN-039', 15, 39, 35),
(74, NOW(), NOW(), '/images/tonkotsu-khong-cay.jpg', 0, 1, 'TONKOTSU-0CAY-039', 50, 39, 37),

-- Sinh Tố Bơ (product_id: 45)
(75, NOW(), NOW(), '/images/sinh-to-bo-std.jpg', 28000, 1, 'SINH-TO-BO-045', 50, 45, NULL),

-- Sinh Tố Dâu (product_id: 46)
(76, NOW(), NOW(), '/images/sinh-to-dau-std.jpg', 32000, 1, 'SINH-TO-DAU-046', 50, 46, NULL),

-- Tiramisu (product_id: 47)
(77, NOW(), NOW(), '/images/tiramisu-std.jpg', 45000, 1, 'TIRAMISU-047', 30, 47, NULL),

-- Salad Caesar (product_id: 49)
(78, NOW(), NOW(), '/images/salad-caesar-std.jpg', 65000, 1, 'SALAD-CAESAR-049', 25, 49, NULL),

-- Xôi Gà (product_id: 41)
(79, NOW(), NOW(), '/images/xoi-ga-std.jpg', 25000, 1, 'XOI-GA-041', 40, 41, NULL),

-- Cháo Gà Tần (product_id: 43)
(80, NOW(), NOW(), '/images/chao-ga-tan-std.jpg', 28000, 1, 'CHAO-GA-TAN-043', 35, 43, NULL);
